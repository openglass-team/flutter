class AiConfig {
  ...
  static const String zhipuKey = 'YOUR_ZHIPU_API_KEY';  // 替换为你的 API Key
  ...
  static const String qwenRealtimeKey = 'YOUR_QWEN_WS_KEY';  // 替换为你的 DashScope WS Key
  ...
  static const String qwenChatKey = 'YOUR_QWEN_API_KEY';  // 替换为你的 DashScope API Key
